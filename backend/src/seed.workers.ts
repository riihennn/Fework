...
const SKILLS: Array<{ category: string; skill: string; bio: string }> = [
  // Repairs & Maintenance
...
async function seed() {
  ...
  const hashedPassword = await bcrypt.hash("Worker@123", 12);

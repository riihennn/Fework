  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col font-sans">
      <main className="flex-grow flex items-center justify-center px-6 py-20 relative overflow-hidden">
        ...
        >
          <div className="bg-white rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 p-8 md:p-12 relative overflow-hidden">
            {/* Progress bar */}
            {isLoading && (
            ...
            <div className="text-center mb-10">
              <h1 className="text-3xl font-bold text-[#0F172A] mb-3">Welcome Back</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                disabled={isLoading}
                className="w-full h-14 bg-[#0F172A] text-white rounded-2xl font-bold hover:bg-gray-800 transition-all shadow-lg shadow-gray-200 flex items-center justify-center gap-2 group active:scale-[0.98] disabled:opacity-70 disabled:pointer-events-none"
              >
                {isLoading ? (
              ...
              <div className="grid grid-cols-1">
                <button type="button" className="h-14 rounded-2xl border border-gray-200 flex items-center justify-center gap-3 hover:bg-gray-50 transition-all font-bold text-sm text-[#0F172A] active:scale-[0.98]">
          ...
          <motion.div
            ...
            className="mt-8 flex items-center justify-center gap-2 text-gray-400 text-xs font-medium uppercase tracking-widest"
          >
